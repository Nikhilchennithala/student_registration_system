...
class mymodel
{
    ...
    function studentregistration($name,$regno,$mobile,$dept,$year,$course,$email,$user,$pass)
    {
        include('../config/connection.php');
        $sq="INSERT INTO student(name,regno,mobile,dept,year,course,email,username,password) VALUES ('".$name."',
        '".$regno."','".$mobile."','".$dept."','".$year."','".$course."','".$email."','".$user."','".$pass."')";
        if(!$result=$conn->query($sq))
        {
            die('Error['.$conn->error.']');
        }
...
function viewadmins()
    ...
    function subjectstudent($id,$stream,$year,$semester,$subject)
    {
        include('../config/connection.php');
        $sq="INSERT INTO subjects(id,stream,year,semester,subject) VALUES ('".$id."','".$stream."','".$year."','".$semester."','".$subject."')";
        if(!$result=$conn->query($sq))
        {
            die('Error['.$conn->error.']');
        }
