		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post">
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					...
					<input id="subject" class="input100" type="text" name="subject" placeholder="Enter username...">
					<span class="focus-input100"></span>
                </div>
                <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<label class="label-input100" for="email">NUMBER OF CREDITS</label>
					<input id="credit" class="input100" type="number" name="credit" placeholder="Enter password...">
					<span class="focus-input100"></span>
				</div>
                <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<label class="label-input100" for="email">SUBJECT COORDINATOR</label>
					<input id="coordinator" class="input100" type="text" name="coordinator" placeholder="Enter name...">
					<span class="focus-input100"></span>
				</div>
